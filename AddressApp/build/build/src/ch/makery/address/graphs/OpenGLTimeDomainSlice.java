...
public class OpenGLTimeDomainSlice {
	...
	public void updateSliceTexture(int sliceNumber, int sliceWidth, int sliceHeight, int plotWidth,
			float domain, float plotMinY, float plotMaxY, int datasetsSize, Dataset[] datasets, 
			Set<Integer> xDivisions, Set<Float> yDivisions, GL2 gl, float levelOne, float levelTwo, 
			float levelThree) {
