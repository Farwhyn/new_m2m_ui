...
public class PersonOverviewController {
    ...
    private void showPersonDetails(Patient patient) {
        if (patient != null) {
            ...
            visitDateLabel.setText(patient.getVisitDate());
        } else {
            // Person is null, remove all the text.
            firstNameLabel.setText("");
            lastNameLabel.setText("");
            streetLabel.setText("");
            careCardLabel.setText("");
            cityLabel.setText("");
    ...
    public void setPersonData(ObservableList<Patient> data) {
        ...
        try {
            ...
            while(rs.next()) {
                ...
                data.add(new Patient(rs.getString("patientID"), rs.getString("lastName"), rs.getString("firstName"), rs.getString("street"),  rs.getString("careCardNum"), rs.getString("city"), rs.getString("regDate")));
            }
